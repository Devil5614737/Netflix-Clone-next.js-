      ...
      <main>
       ...
       <div className=" md:w-card md:h-card w-full p-9 bg-cardBg ">
             ...
             <div  className="w-full ">
                 <button onClick={login} className='cursor-pointer rounded-md bg-netflix w-full text-white font-semibold text-3xl p-4'>Sign In</button>
             </div>
