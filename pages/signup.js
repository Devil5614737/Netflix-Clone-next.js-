      ...
      <main>
        ...
        <div className="md:grid md:place-items-center">
          <div className="md:w-card md:h-card w-full p-9 bg-cardBg ">
            <div className="">
              <p className="font-bold text-white text-5xl">Sign Up</p>
            </div>
            <div className="w-full mt-12">
              <input
                onChange={(e) => setEmail(e.target.value)}
                className="rounded-md w-full mb-8 h-16 text-2xl pl-2 text-white bg-input focus:outline-none focus:bg-inputFocus"
                type="email"
                placeholder="email"
              />
              <input
